...
const onSaveNext = async () => {
  ...
  return (
    <section className="w-full h-full flex flex-col min-h-0">
      <div className='flex-col flex w-full h-[90%] overflow-y-auto'>
         ...
         <div
        className="w-full min-h-0 h-full  overflow-y-auto overflow-x-hidden p-3 sm:p-4
  ...
  className="w-full border border-[#ECECEC] rounded-lg px-3 py-2 text-sm"
      ...
      {/* Footer (NOT scrollable, sticks to bottom of this section) */}
      <div className="w-full h-[10%] border-t border-[#ECECEC] pt-4 mt-4 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60">
        <div className="flex items-center justify-end gap-2 sm:gap-4">
          <button
            type="button"
            onClick={onGoBack}
            className="w-[90px] sm:w-[113px] h-[40px] sm:h-[44px] border border-[#ECECEC] rounded-[15px] flex items-center justify-center text-[#787878] text-[14px] sm:text-[16px] font-[500]"
          >
            Go back
          </button>
          <button
            ...
            className={`w-[100px] sm:w-[126px] h-[40px] sm:h-[44px] rounded-[15px] flex items-center justify-center text-white text-[14px] sm:text-[16px] font-[500] ${loading || saving || !isValid || !waitlistId ? 'bg-[#0A5DBC]/60 cursor-not-allowed' : 'bg-[#0A5DBC]'
              }`}
          >
